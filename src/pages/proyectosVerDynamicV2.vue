...
const projectsList = ref([
    ...
    },
    {
		...
		imagenes: [
			...
			'/img/PROYECTOS/02CuestaSanAntonioJavea/CuestaSanAntonio-D.webp',
    ...
    },
    {
		...
		imagenes: [
			...
			'/img/PROYECTOS/03CasaCaracolJavea/CasaCaracol-E.webp',
			'/img/PROYECTOS/03CasaCaracolJavea/CasaCaracol-F.webp',
			'/img/PROYECTOS/03CasaCaracolJavea/CasaCaracol-G.webp',
		],
    },
    {
        id: 'EsCanarIbiza',
    ...
    },
    {
		...
		imagenes: [
			'/img/PROYECTOS/08LAmetllaDelValles/03LAmetllaDelValles-Piscina01.webp',
